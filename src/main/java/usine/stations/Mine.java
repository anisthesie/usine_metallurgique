...
public class Mine extends Station {
    ...
    /**
     * Retourne le minerai produit par la mine.
     *
     * @return le minerai produit par la mine.
     */
            ...
            case CHARBON:
                if (compteur == 1) {
                    try {
                        ...
                        parent.ajouterNotification("La mine de charbon en (" + this.getX() + "," + this.getY() + ") : " + e.getMessage());
                    }
                    compteur = 0;
                }
                break;
            case ACANTHITE:
                if (compteur == 2) {
                    try {
                        ...
                        parent.ajouterNotification("La mine d'Acanthite en (" + this.getX() + "," + this.getY() + ") : " + e.getMessage());
                    }
                    compteur = 0;
                }
                break;
            case CASSITERITE:
                if (compteur == 7) {
                    try {
                        ...
                        parent.ajouterNotification("La mine de Cassiterite en (" + this.getX() + "," + this.getY() + ") : " + e.getMessage());
                    }
                    compteur = 0;
                }
                break;
            case CHALCOCITE:
                if (compteur == 3) {
                    try {
                        ...
                        parent.ajouterNotification("La mine de Chalcocite en (" + this.getX() + "," + this.getY() + ") : " + e.getMessage());
                    }
                    compteur = 0;
                }
                break;
