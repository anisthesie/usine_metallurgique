...
public enum TapisRoulant {
    ...
    public TapisRoulant combine(TapisRoulant depart) {
        return
                switch (this) {
                    case VIDE -> depart;
                    case HAUT_BAS, HAUT_DROITE, HAUT_GAUCHE -> switch (depart) {
                    ...
                    case DROITE_GAUCHE, DROITE_HAUT, DROITE_BAS -> switch (depart) {
                    ...
                    case BAS_HAUT, BAS_DROITE, BAS_GAUCHE -> switch (depart) {
                    ...
                    case GAUCHE_DROITE -> switch (depart) {
